                            ...
                            <div class="p-4 border mb-4">
                                <div class="row">
                                    <div class="col-lg-12 form-group">
                                        <label class="mb-0">@lang('Your Currency')</label>
                            ...
                            <div class="p-4 border mb-4">
                                <div class="row">
                                    <div class="col-lg-6 form-group">
                                        <label class="mb-0">@lang('Amount to transfer')<span class="text--danger">*</span>
                                        </label>
                                        <input type="number" step="any" class="form--control style--two amount"
                                            name="amount" disabled placeholder="0.00" required value="{{ old('amount') }}">
                                        <label>
                                            <span class="text--warning min">
                                                @lang('Min: '){{ getAmount(@$transferCharge->min_limit) }}
                                                {{ defaultCurrency() }} --
                                            </span>
                                            <span class="text--warning max">
                                                @lang('Max: '){{ getAmount(@$transferCharge->max_limit) }}
                                                {{ defaultCurrency() }}
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form--control checkUser" id="username"
                                                name="user" placeholder="@lang('Receiver Username / E-mail')" value="{{ old('user') }}"
                                                required>
