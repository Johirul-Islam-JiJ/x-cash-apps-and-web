                ...
                <form action="" method="POST" id="form">
                                    ...
                                    <div class="p-4 border mb-4">
                                        <div class="row">
                                            <div class="col-lg-12 form-group">
                                                <label class="mb-0">@lang('Merchant Username/E-mail')<span class="text--danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <input type="text" class="form--control checkUser" id="username"
                                                        name="merchant" placeholder="@lang('Merchant Username/E-mail')"
                                                        value="{{ old('merchant') }}" required>
                                                    <button type="button" class="input-group-text scan"
                                                        data-toggle="tooltip" title="Scan QR"><i
                                                            class="las la-camera"></i></button>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                        <div class="text-center">
                            <button type="submit"
                                class="btn btn-md btn--base mt-4 payment w-100">@lang('Make Payment')</button>
                        </div>
                    </div>
                </form>
            </div>
