                        ...
                        <div class="d-widget shadow-sm">
                            ...
                            <div class="d-widget__content px-5">
                                <div class="p-4 border mb-4">
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <label class="mb-0">@lang('Select Wallet')<span
                                ...
                                <div class="p-4 border mb-4">
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <label class="mb-0">@lang('User Username/E-mail')<span class="text--danger">*</span>
                                            </label>
                                            <input type="text" class="form--control checkUser" name="user"
                                                placeholder="@lang('User Username/E-mail')" required value="{{ old('user') }}">
                                        </div>
                                ...
                                <div class="p-4 border mb-4">
                                    <div class="row">
                                        ...
                                        <label>
                                            <span
                                                class="text--warning min">@lang('Min: '){{ getAmount($moneyInCharge->min_limit) }}
                                                {{ defaultCurrency() }} --</span>
                                            <span
                                                class="text--warning max">@lang('Max: '){{ getAmount($moneyInCharge->max_limit) }}
                                                {{ defaultCurrency() }}</span>
                                        </label>
                                    </div><!-- row end -->
                                </div>
                                ...
                                @endif
                                <button type="submit"
                                    class="btn btn-md btn--base mt-4 money_in w-100">@lang('Money In')</button>
                            </div>
                        </div>
                    </div>
                </div>
